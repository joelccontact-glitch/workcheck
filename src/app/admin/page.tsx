...
export default function AdminPage() {
  const { coords, loading: locLoading, refresh } = useGeolocation();
          ...
          <div style={{ display: 'grid', gap: '1.25rem' }}>
            ...
            <div>
              ...
              <input 
                ...
                style={inputStyle} 
              />
              <p style={{ fontSize: '0.75rem', color: 'hsl(var(--muted-foreground))', marginTop: '0.25rem' }}>설정된 좌표로부터 해당 반경 내에서만 출퇴근이 가능합니다.</p>
            </div>
          </div>
        </section>
