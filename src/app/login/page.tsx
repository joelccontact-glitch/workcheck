          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="pmo-card border-amber-900/50 bg-slate-900/90 hover:border-amber-500 transition-all flex flex-col justify-between space-y-4 group">
              <div className="space-y-3">
                ...
                <ul className="text-xs text-slate-300 space-y-1.5 pt-2 border-t border-slate-800">
                  ...
                  <li className="flex items-center gap-1.5"><CheckCircle2 size={13} className="text-amber-400 shrink-0" /> G1~G6 Gate Review 결재 & HOLD 통제</li>
            ...
            <div className="pmo-card border-indigo-900/50 bg-slate-900/90 hover:border-indigo-500 transition-all flex flex-col justify-between space-y-4 group">
              <div className="space-y-3">
                ...
                <ul className="text-xs text-slate-300 space-y-1.5 pt-2 border-t border-slate-800">
                  <li className="flex items-center gap-1.5"><CheckCircle2 size={13} className="text-indigo-400 shrink-0" /> Step 01~07 순차적 데이터 입력 (CRUD)</li>
                  <li className="flex items-center gap-1.5"><CheckCircle2 size={13} className="text-indigo-400 shrink-0" /> 주간 점검표 & Health Score 작성</li>
                  <li className="flex items-center gap-1.5"><CheckCircle2 size={13} className="text-indigo-400 shrink-0" /> 16종 산출물 업로드 & Gate 자가진단</li>
                </ul>
              </div>

              <button
                onClick={() => loginAsPreset('PM')}
                className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs transition-all shadow-lg shadow-indigo-600/25 flex items-center justify-center gap-2"
              >
                <span>🎯 PM 계정으로 로그인</span>
                <ArrowRight size={14} />
              </button>
            </div>
            ...
            <div className="pmo-card border-purple-900/50 bg-slate-900/90 hover:border-purple-500 transition-all flex flex-col justify-between space-y-4 group">
              <div className="space-y-3">
                ...
                <ul className="text-xs text-slate-300 space-y-1.5 pt-2 border-t border-slate-800">
                  ...
                  <li className="flex items-center gap-1.5"><CheckCircle2 size={13} className="text-purple-400 shrink-0" /> 계정 승인/비활성화/비밀번호 초기화</li>
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs transition-all shadow-lg shadow-purple-600/25 flex items-center justify-center gap-2"
              >
                <span>⚙️ 사이트 관리자로 로그인</span>
                <ArrowRight size={14} />
              </button>
            </div>
          </div>
